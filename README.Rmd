 ...
 * Interactive simulation plot allows the plotting of many trajectories at once
...
Rackauckas, C., & Nie, Q. (2017). Differentialequations. jl–a performant and feature-rich ecosystem for solving differential equations in julia. _Journal of Open Research Software_, 5(1).

Rackauckas, C., & Nie, Q. (2017). Adaptive methods for stochastic differential equations via natural embeddings and rejection sampling with memory. _Discrete and continuous dynamical systems_. Series B, 22(7), 2731.
