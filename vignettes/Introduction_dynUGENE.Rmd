...
<div style="text-align:center"><img src="hh-allcurrents.png" alt="rep" width="400"/><div style="text-align:left">

We also provide Hodgkin-Huxley data with noise, some examples are shown below. $I_{\text{applied}} = 10$ in all cases.

<div style="text-align:center"><img src="hh-3stochastic.png" alt="rep" width="400"/><div style="text-align:left">
